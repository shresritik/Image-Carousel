...
var childElement = container === null || container === void 0 ? void 0 : container.children;
var initDot = 0;
...
for (var i = 0; i < childElement.length; i++) {
    ...
    div.className = "dots";
    dotsContainer === null || dotsContainer === void 0 ? void 0 : dotsContainer.appendChild(div);
}
...
dots.forEach(function (el, i) {
    var element = el;
    buttonColor(initDot);
    element.addEventListener("click", function () { return dotsFunc(i); });
});
...
prev === null || prev === void 0 ? void 0 : prev.addEventListener("click", prevFunc);
next === null || next === void 0 ? void 0 : next.addEventListener("click", nextFunc);
var timer = function () {
